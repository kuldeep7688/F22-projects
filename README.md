...
2. **Entity Extraction**
    ...
    - Exntities can be name of a person, location, date etc. 
3. **Relationship Classification/Extraction**
    - Identifying relationships between entities give the context.
...
5. **Frontend and Visualizations**
    - Visualizing the knowledge graph created using NER and Relationship Extraction.
